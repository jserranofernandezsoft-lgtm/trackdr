...
<div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;margin-top:20px;">
    ...
    {{-- Dona: Activos Fijos por Estado --}}
    <div class="card" style="padding:16px;">
        <div style="font-size:12px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:.4px;margin-bottom:12px;">Fijos por Estado</div>
        <div style="position:relative;height:160px;">
            <canvas id="chart-estados"></canvas>
        </div>
    </div>

    {{-- Dona: Activos Menores por Estado --}}
    <div class="card" style="padding:16px;">
        <div style="font-size:12px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:.4px;margin-bottom:12px;">Menores por Estado</div>
        <div style="position:relative;height:160px;">
            <canvas id="chart-menores"></canvas>
        </div>
    </div>

    {{-- Barras: Activos Fijos por Tipo --}}
    <div class="card" style="padding:16px;">
        <div style="font-size:12px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:.4px;margin-bottom:12px;">Fijos por Tipo</div>
        <div style="position:relative;height:160px;">
    ...
    <div class="card" style="padding:16px;">
        <div style="font-size:12px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:.4px;margin-bottom:12px;">Resumen General</div>
        <div style="position:relative;height:160px;">
...
// Dona 1: Activos Fijos por Estado
...
// Dona 2: Activos Menores por Estado
...
// Barras 1: Activos Fijos por Tipo
...
// Barras 2: Resumen General
new Chart(document.getElementById('chart-resumen'), {
    type: 'bar',
    data: {
        labels: ['A. Fijos', 'A. Menores', 'Colaboradores', 'Deptos.'],
        datasets: [{
